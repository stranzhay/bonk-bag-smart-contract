...
contract BonkBag is ERC721URIStorage {
    ...
    event NewBonkBagMinted(address sender, uint256 tokenId);

    constructor() ERC721("BonkBagNFT", "BONK") {
    ...
    function makeABonkBagNFT() public {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '", "description": "Fashionable nonsense", "image": "data:image/svg+xml;base64,',
        ...
        emit NewBonkBagMinted(msg.sender, newItemId);
    }
}
